...
ARGUMENTS = [
    ...
    # Which TurtleBot 4 model to use
    DeclareLaunchArgument('model', default_value='standard',
                          choices=['standard', 'lite'],
                          description='Turtlebot4 Model'),

    # Optional robot namespace : to avoid multiple robots pushing to the same topic
    DeclareLaunchArgument('namespace', default_value='',
                          description='Robot namespace'),

    #  Whether to launch localization 
    DeclareLaunchArgument('localization', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to launch localization'),
    
    # Whether to launch SLAM 
    DeclareLaunchArgument('slam', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to launch SLAM'),

    # Whether to launch Nav2 
    DeclareLaunchArgument('nav2', default_value='false',
                          choices=['true', 'false'],
                          description='Whether to launch Nav2'),

    # x coordinate of the robot and dock spawn location in the gazebo world
    DeclareLaunchArgument('x', default_value='0.0',
                     description='x component of the robot pose.'),
    
    # y coordinate of the robot and dock spawn location in the gazebo world
    DeclareLaunchArgument('y', default_value='0.0',
                     description='y component of the robot pose.'),

    # z coordinate of the robot and dock spawn location in the gazebo world
    DeclareLaunchArgument('z', default_value='0.0',
                     description='z component of the robot pose.'),

    # robot and dock orientation at spawn in the gazebo world 
